...
namespace webapi22.example.data_access.FactoryClasses
{
	...
	{
		private readonly webapi22.example.data_access.EntityType _typeOfEntity;
		private readonly bool _isInHierarchy;

		/// <summary>CTor</summary>
		/// <param name="entityName">Name of the entity.</param>
		/// <param name="typeOfEntity">The type of entity.</param>
		public EntityFactoryBase(string entityName, webapi22.example.data_access.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity CreateEntityFromEntityTypeValue(int entityTypeValue) { return GeneralEntityFactory.Create((webapi22.example.data_access.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public TodoListEntityFactory() : base("TodoListEntity", webapi22.example.data_access.EntityType.TodoListEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public TodoListItemEntityFactory() : base("TodoListItemEntity", webapi22.example.data_access.EntityType.TodoListItemEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", webapi22.example.data_access.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityCollectionFactory
	{
		...
		public static IEntityCollection Create(webapi22.example.data_access.EntityType typeToUse)
		{
			switch(typeToUse)
			{
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity Create(webapi22.example.data_access.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(webapi22.example.data_access.EntityType)))
			{
				var factory = GetFactory((webapi22.example.data_access.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the webapi22.example.data_access.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory GetFactory(webapi22.example.data_access.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case webapi22.example.data_access.EntityType.TodoListEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the webapi22.example.data_access.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (webapi22.example.data_access.EntityType)Enum.Parse(typeof(webapi22.example.data_access.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((webapi22.example.data_access.EntityType)Enum.Parse(typeof(webapi22.example.data_access.EntityType), leftOperandEntityName, false), joinType, (webapi22.example.data_access.EntityType)Enum.Parse(typeof(webapi22.example.data_access.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (webapi22.example.data_access.EntityType)Enum.Parse(typeof(webapi22.example.data_access.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) {	return EntityFactoryFactory.GetFactory((webapi22.example.data_access.EntityType)entityTypeValue); }
