...
namespace webapi22.example.data_access.EntityClasses
{
	...
	public partial class UserEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		private webapi22.example.data_access.CollectionClasses.TodoListCollection	_todoLists;
		...
		protected class UserEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserEntity", InheritanceHierarchyType.None, false, (int)webapi22.example.data_access.EntityType.UserEntity, typeof(UserEntity), typeof(UserEntityFactory), false);
				AddNavigatorMetaData<UserEntity, TodoListCollection>("TodoLists", a => a._todoLists, (a, b) => a._todoLists = b, a => a.TodoLists, () => new UserRelations().TodoListEntityUsingUserId, typeof(TodoListEntity), (int)webapi22.example.data_access.EntityType.TodoListEntity);
			}
		}
		...
		public webapi22.example.data_access.CollectionClasses.TodoListCollection GetMultiTodoLists(bool forceFetch)
		{
		...
		/// <returns>Filled collection with all related entities of type 'TodoListEntity'</returns>
		public webapi22.example.data_access.CollectionClasses.TodoListCollection GetMultiTodoLists(bool forceFetch, IPredicateExpression filter)
		{
		...
		public webapi22.example.data_access.CollectionClasses.TodoListCollection GetMultiTodoLists(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual webapi22.example.data_access.CollectionClasses.TodoListCollection GetMultiTodoLists(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
			return PerformMultiEntityLazyLoading<webapi22.example.data_access.CollectionClasses.TodoListCollection>("TodoLists", forceFetch, entityFactoryToUse, (c,r)=>c.GetMultiManyToOne(this, filter));
		}
		...
		{
			_todoLists = new webapi22.example.data_access.CollectionClasses.TodoListCollection();
		...
		public static IPrefetchPathElement PrefetchPathTodoLists { get { return _staticMetaData.GetPrefetchPathElement("TodoLists", new webapi22.example.data_access.CollectionClasses.TodoListCollection()); } }
		...
		public virtual webapi22.example.data_access.CollectionClasses.TodoListCollection TodoLists { get { return GetMultiTodoLists(false); } }
