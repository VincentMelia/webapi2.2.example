...
namespace webapi22.example.data_access.sql.FactoryClasses
{
	...
	{
		private static readonly Dictionary<webapi22.example.data_access.sql.EntityType, string> _entityTypeNamesCache = new Dictionary<webapi22.example.data_access.sql.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(webapi22.example.data_access.sql.EntityType value in Enum.GetValues(typeof(webapi22.example.data_access.sql.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(webapi22.example.data_access.sql.EntityType), value));
			}
		}	
		...
		public static IEntityFields CreateEntityFieldsObject(webapi22.example.data_access.sql.EntityType relatedEntityType)
		{
