...
namespace webapi22.example.data_access.sql.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class TodoListItemEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("TodoListItemEntity", InheritanceHierarchyType.None, false, (int)webapi22.example.data_access.sql.EntityType.TodoListItemEntity, typeof(TodoListItemEntity), typeof(TodoListItemEntityFactory), false);
				AddNavigatorMetaData<TodoListItemEntity, TodoListEntity>("TodoList", "TodoListItems", (a, b) => a._todoList = b, a => a._todoList, (a, b) => a.TodoList = b, webapi22.example.data_access.sql.RelationClasses.StaticTodoListItemRelations.TodoListEntityUsingTodoListIdStatic, ()=>new TodoListItemRelations().TodoListEntityUsingTodoListId, null, new int[] { (int)TodoListItemFieldIndex.TodoListId }, null, true, (int)webapi22.example.data_access.sql.EntityType.TodoListEntity);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathTodoList { get { return _staticMetaData.GetPrefetchPathElement("TodoList", new webapi22.example.data_access.sql.CollectionClasses.TodoListCollection()); } }
